...
describe("noOfVerifiedReviews", () => {
  test("Task-6 returns the number of verified reviews", () => {
...
describe("calculateAverageRating", () => {
  test("Task-5 returns the average rating of products", () => {
...
describe("sortProductsByRating", () => {
  test("Task-6 returns the products sorted by rating in descending order", () => {
...
describe("isPalindrome", () => {
  test("Task-7.a returns true for a palindrome string", () => {
  ...
  test("Task-7.b returns false for a non-palindrome string", () => {
